"""
Model Registry for Cost & Time Predictor.
...
class ModelMetadata:
    ...
    Attributes:
        ...
        validation_mae: Mean absolute error per target on validation set
...
class ModelRegistry:
    """
    Local registry for trained cost/time prediction models.
    
    Features:
    - Versioned model storage
    - Metadata tracking (training time, dataset size, validation error)
    ...
    def __init__(self, base_dir: Optional[Path] = None):
        ...
        Args:
            base_dir: Base directory for model storage. 
                     Defaults to kb/models/cost_time_predictor
        """
        if base_dir is None:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        if versions:
            ...
            if metadata:
                ...
                stats["latest_validation_mae"] = metadata.validation_mae

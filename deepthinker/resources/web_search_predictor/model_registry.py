"""
Model Registry for Web Search Predictor.
...
class ModelMetadata:
    ...
    Attributes:
        ...
        validation_metrics: Validation metrics (search_auc, hallucination_mae, etc.)
...
class WebSearchModelRegistry:
    """
    Local registry for trained web search prediction models.
    ...
    def __init__(self, base_dir: Optional[Path] = None):
        ...
        Args:
            base_dir: Base directory for model storage. 
                     Defaults to kb/models/web_search_predictor
        """
        if base_dir is None:
